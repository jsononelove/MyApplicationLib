...
public class Cube1 {
    ...
    public Cube1(float n, float n2, float n3, float n4, float n5, float n6) {
    ...
    public Cube1(float n, float n2, float n3, float n4, float n5, float n6, float main_step_value, float n7, float n8, float n9, float main_max_angle, float main_min_angle, float sub_step_value, float sub_max_angle, float sub_min_angle, boolean isFixOneAxis, float fixedDir) {
    ...
    public void draw(GL10 gl10, boolean b) {
        ...
        for (int i = 0; i < this.face_indecies.length; i++) {
            float n4;
            float n5;
            int n = this.face_indecies[i];
            float n2 = (this.vertices[(n * 3) + 1] * this.mScale[1]) / 2.0f;
            float n3 = (this.vertices[(n * 3) + 2] * this.mScale[2]) / 2.0f;
            if (!b) {
                n4 = n2;
                n5 = n3;
            } else if (n == 0 || n == 1 || n == 4 || n == 5) {
                float n6 = (float) ((((double) n2) * Math.cos(((double) ((this.mSubAngle / 180.0f) * 2.0f)) * 3.141592653589793d)) + (((double) n3) * Math.sin(((double) ((this.mSubAngle / 180.0f) * 2.0f)) * 3.141592653589793d)));
                float n7 = (float) ((((double) n3) * Math.cos(((double) ((this.mSubAngle / 180.0f) * 2.0f)) * 3.141592653589793d)) - (((double) n2) * Math.sin(((double) ((this.mSubAngle / 180.0f) * 2.0f)) * 3.141592653589793d)));
                n4 = n6;
                n5 = n7;
